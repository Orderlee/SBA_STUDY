...
print('positional argument') #인덱스 기반 매개 변수 대
...
# 서식 지정자: %s(string) %d(decimal(숫자)),
# %f(float 실수) : 기본 값으로 소수점 6자리 까지 표시
...
su2 = 9
# 4곱하기 9는 36입니다.
myprint = '%d곱하기 %d는 %d입니다.'
print(myprint %(su1,su2,su1*su2))
...
b=10.0
result=pow(a,b)
myprint= '%.2f의 %.2f승은 %.2f입니다.'
print(myprint %(a,b,result))
