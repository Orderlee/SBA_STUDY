...
# 형태소 : 의미있는 최소의 단위
# 텍스트 마이닝 : 수많은 텍스트에서 간추려서 의미있는 데이터만 추려내는 행위
...
komo = Komoran(userdic='../0911/03_user_dict.txt')
#[('국정', 'NNG'), ('농', 'NNG'), ('단', 'NNG'), ('태블릿', 'NNP'), ('pc', 'SL'), (',', 'SP'), ('설지', 'NNP'), ('ㄴ', 'JX'), ('욱', 'MAG'), (',', 'SP'), ('가나', 'NNP'), ('다라', 'NNP')]
print(komo.pos(sentence))
print('-'*30)
sentence ='국정 농단 태플릿 PC,설진욱,가나다라'
komo = Komoran(userdic='../0911/03_user_dict.txt')
